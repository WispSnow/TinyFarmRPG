...
def validate_shader_boundary(root: Path, gate: Gate) -> dict[str, Any]:
    ...
    required_phase18_snippets = (
        ...
        (gl_renderer_text, "gl_renderer.cpp", "detectRenderCapabilities"),
        (gl_renderer_text, "gl_renderer.cpp", "queryWebGlExtension(\"EXT_color_buffer_float\")"),
        (gl_renderer_text, "gl_renderer.cpp", "queryWebGlExtension(\"OES_texture_float_linear\")"),
        (gl_renderer_text, "gl_renderer.cpp", "probeColorRenderableFormat(GL_RGBA16F, GL_RGBA, GL_HALF_FLOAT)"),
        (gl_renderer_text, "gl_renderer.cpp", "hdr_fallback_reason"),
        ...
        (web_smoke_text, "web_smoke.py", "wait_for_render_postprocessing_activity"),
