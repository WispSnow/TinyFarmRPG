...
每个图标在 16×16 的网格 cell 中（图标本身小于 16×16，居中绘制）。
...
|---------|-------------|----------------|------|
| Hat 帽子 | `equip-hat` | (0, 32, 16, 32) | 浅色占位 |
| Shirt 上衣 | `equip-shirt` | (16, 32, 16, 32) | 浅色占位 |
| Pants 裤子 | `equip-pants` | (32, 32, 16, 32) | 浅色占位 |
| Gloves 手套 | `equip-gloves` | (48, 32, 16, 32) | 浅色占位 |
| Boots 鞋子 | `equip-boots` | (64, 32, 16, 32) | 浅色占位 |
| Necklace 项链 | `equip-necklace` | (80, 32, 16, 32) | 浅色占位 |
| Ring 戒指 | `equip-ring` | (96, 32, 16, 32) | 浅色占位（ring1/ring2 共用） |

> 注意: cell 高度为 32px（y=32~63），图标内容集中在 y=40-55 区域。
> RCSS 中使用 `(x, 32, 16, 32)` 整个 cell，图标自然居中。
