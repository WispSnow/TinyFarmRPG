...
本目录包含TinyFarm项目的模块化CMake配置文件，将原本庞大的CMakeLists.txt拆分为多个功能独立的模块。

> 💡 **提示**：查看 [QUICK_REFERENCE.md](QUICK_REFERENCE.md) 获取常用命令和代码片段速查。
...
### 5. OpenGL.cmake
**功能**：OpenGL 配置
- 配置 OpenGL 相关的头文件路径与库链接
- 确保图形 API 依赖正确加载

---

### 6. BuildHelpers.cmake
**功能**：构建辅助工具
- 资源文件自动复制
- 配置文件(`config/`)自动复制
- Windows DLL自动检测和复制
