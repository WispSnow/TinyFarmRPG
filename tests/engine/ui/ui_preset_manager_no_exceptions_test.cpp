...
TEST(UIPresetManagerNoExceptionsTest, UIPresetManagerCppHasNoTryCatch) {
    const std::filesystem::path source_path =
        (std::filesystem::path{PROJECT_SOURCE_DIR} / "src/engine/ui/ui_preset_manager.cpp").lexically_normal();
