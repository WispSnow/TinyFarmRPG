...
TEST(RmlDocumentControllerSourceTest, HeaderKeepsOnlyTheControllerApiUsedByCurrentScenes) {
    ...
    EXPECT_NE(source.find("enableHoverFocusSync("), std::string::npos);
    EXPECT_NE(source.find("setDefaultFocusById("), std::string::npos);
    EXPECT_NE(source.find("setDefaultFocusFirstEnabledByClass("), std::string::npos);
    EXPECT_NE(source.find("queueDefaultFocus()"), std::string::npos);
    EXPECT_NE(source.find("queueFocusElement("), std::string::npos);
    EXPECT_NE(source.find("queueFocusElementById("), std::string::npos);
    EXPECT_NE(source.find("queueFocusFirstEnabledElementByClass("), std::string::npos);
