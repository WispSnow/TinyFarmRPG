...
TEST(InputManagerNoExceptionsTest, InputManagerCppHasNoTryCatch) {
    const std::filesystem::path source_path =
        (std::filesystem::path{PROJECT_SOURCE_DIR} / "src/engine/input/input_manager.cpp").lexically_normal();
