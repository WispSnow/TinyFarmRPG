...
TEST(ShopMenuSceneSmokeTest, ShopMenuSceneOwnsMinimalSceneAndDocumentController) {
    ...
    EXPECT_NE(init_ui_block.find("bindSimpleEvent(constructor, \"buy_confirm\""), std::string::npos);
    ...
    EXPECT_NE(preview_block.find("shop_transaction_service_->previewBuy"), std::string::npos);
