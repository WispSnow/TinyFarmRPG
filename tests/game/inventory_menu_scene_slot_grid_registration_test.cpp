...
TEST(InventoryMenuSceneSlotGridRegistrationTest, InventoryMenuRmlUsesNavigationRootAndNativeTabset) {
    ...
    EXPECT_NE(theme.find("src: ../../../assets/farm-rpg/Icons/Weapons/RPG/3.png;"), std::string::npos);
    EXPECT_NE(theme.find("item-equipment-iron-sword:     176px  0px 16px 16px;"), std::string::npos);
    EXPECT_NE(theme.find("item-equipment-iron-staff:     160px 16px 16px 16px;"), std::string::npos);
    EXPECT_NE(theme.find("item-equipment-iron-helmet:    144px 32px 16px 16px;"), std::string::npos);
    EXPECT_NE(theme.find("item-equipment-iron-armor:     160px 32px 16px 16px;"), std::string::npos);
    EXPECT_NE(theme.find("item-equipment-iron-boots:     192px 32px 16px 16px;"), std::string::npos);
    EXPECT_NE(theme.find("item-equipment-iron-accessory: 224px 32px 16px 16px;"), std::string::npos);
