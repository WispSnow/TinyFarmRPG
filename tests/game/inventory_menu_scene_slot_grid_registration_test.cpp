...
TEST(InventoryMenuSceneSlotGridRegistrationTest, InventoryMenuTabShortcutsUseNativeTabsetPath) {
    ...
    EXPECT_NE(source.find("\"I\""), std::string::npos);
    EXPECT_NE(source.find("\"C\""), std::string::npos);
    EXPECT_NE(source.find("\"J\""), std::string::npos);
    EXPECT_NE(source.find("\"M\""), std::string::npos);
    EXPECT_NE(source.find("\"O\""), std::string::npos);
    EXPECT_EQ(source.find("\"Inventory [I]\""), std::string::npos);
    EXPECT_EQ(source.find("\"Equipment [C]\""), std::string::npos);
    EXPECT_EQ(source.find("\"Quests [J]\""), std::string::npos);
    EXPECT_EQ(source.find("\"Map [M]\""), std::string::npos);
    EXPECT_EQ(source.find("\"Options [O]\""), std::string::npos);
