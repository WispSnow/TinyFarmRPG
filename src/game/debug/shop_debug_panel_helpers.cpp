...
ShopDebugBuyRow buildShopDebugBuyRow(const game::data::ShopBuyEntryData& buy_entry,
    ...
    row.item_name = resolveDisplayName(item_catalog, localization, buy_entry.item_id_hash_, buy_entry.item_id_);
...
ShopDebugSellRow buildShopDebugSellRow(const int slot_index,
    ...
    row.item_name = resolveDisplayName(item_catalog, localization, stack.item_id_, row.item_id);
